...
public sealed class ChromeWindowUrlCorrelationTests
{
    private const string MarkerUrl =
        "https://openai-flow.invalid/microphone/84a7792c-80b3-46fb-8296-72c94f9dbb15";

    [Theory]
    [InlineData(null)]
    [InlineData("")]
    [InlineData("https://openai-flow.invalid/")]
    [InlineData("https://openai-flow.invalid/microphone/84a7792c-80b3-46fb-8296-72c94f9dbb15 ")]
    [InlineData("HTTPS://OPENAI-FLOW.INVALID/MICROPHONE/84A7792C-80B3-46FB-8296-72C94F9DBB15")]
    [InlineData("prefix-https://openai-flow.invalid/microphone/84a7792c-80b3-46fb-8296-72c94f9dbb15")]
    ...
    public void ExactChromeOmniboxValueMatchesWhenOnlyHttpsSchemeIsElided()
    {
        Assert.True(ChromeWindowUrlCorrelation.IsExactMatch(
            "openai-flow.invalid/microphone/84a7792c-80b3-46fb-8296-72c94f9dbb15",
            MarkerUrl));
    }
...
public sealed class ChromeProfileLauncherArgumentTests
{
    ...
    public void BackgroundMarkerContainsTheExactCorrelationGuid()
    {
        ...
        Assert.Equal(
            "https://openai-flow.invalid/background/41934fdd-fe29-4751-a1c5-1047f33531e2",
    ...
    public void EachBackgroundLaunchUsesANewMarker()
    {
        ...
        Assert.StartsWith("https://openai-flow.invalid/background/", first, StringComparison.Ordinal);
    }
    ...
    {
        const string prefix = "https://openai-flow.invalid/microphone/";
    ...
    public void VisibleChromeLaunchUsesSeparateArgumentsWithoutStartMinimized()
    {
        var startInfo = ChromeProfileLauncher.CreateChromeStartInfo(
            ...
            "Profile 7",
            "https://chatgpt.com/#openai-flow-window-correlation",
